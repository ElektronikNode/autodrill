...
# Form implementation generated from reading ui file 'autodrill/ui/dialogDrills.ui'
#
...
class Ui_DialogDrills(object):
    def setupUi(self, DialogDrills):
        ...
        self.tableWidget_drills.setColumnCount(2)
        ...
        item = QtGui.QTableWidgetItem()
        self.tableWidget_drills.setHorizontalHeaderItem(1, item)
        self.tableWidget_drills.horizontalHeader().setDefaultSectionSize(150)
        self.tableWidget_drills.horizontalHeader().setStretchLastSection(True)
        self.tableWidget_drills.verticalHeader().setVisible(False)
    ...
    def retranslateUi(self, DialogDrills):
        ...
        item = self.tableWidget_drills.horizontalHeaderItem(1)
        item.setText(_translate("DialogDrills", "ToolNr.", None))
